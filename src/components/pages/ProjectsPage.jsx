...
export default function ProjectsPage() {
  return (
    <div>
      ...
      <div style={{ padding: '32px 64px 64px', borderTop: '1px solid var(--cream-dark)', marginTop: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <p style={{ fontSize: 13, color: 'var(--ink-light)', fontWeight: 300 }}>
          More experiments, scripts and open source work live on GitHub.
        </p>
        <a href={DATA.github} target="_blank" rel="noopener noreferrer" className="btn-outline" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
